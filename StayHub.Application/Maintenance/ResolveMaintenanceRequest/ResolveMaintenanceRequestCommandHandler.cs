...
internal sealed class ResolveMaintenanceRequestCommandHandler(
...
{
    public async Task<Result> Handle(ResolveMaintenanceRequestCommand request, CancellationToken cancellationToken)
    {
        ...
        var result = maintenanceRequest.Resolve(dateTimeProvider.UtcNow);
