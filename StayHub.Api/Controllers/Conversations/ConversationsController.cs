...
using StayHub.Application.Conversations.GetConversationsByUser;
...
public sealed class ConversationsController(ISender sender) : ControllerBase
{
    ...
    public async Task<ActionResult<IReadOnlyList<ConversationSummaryResponse>>> GetByUser(
        Guid userId,
        CancellationToken cancellationToken)
    {
        var query = new GetConversationsByUserQuery(userId);
